...
// um método para calcular a idade do jogador 
...
class Jogador{
    ...
    aposentadoria(jogador){
        ...
        if (this.posicao == "defesa") {
            let defesa = 40 - idade
        return (`O jogador se aposentará com 40 anos. Faltam ${defesa} anos.`)
        }
        else if (this.posicao == "meio-campo") {
            let meioCampo = 38 - idade
            return (`O jogador se aposentará com 38 anos. Faltam ${meioCampo} anos.`)
        } else {
            let atacante = 35 - idade
            return (`O jogador se aposentará com 35 anos. Faltam ${atacante} anos.`)
        }
    }
}
